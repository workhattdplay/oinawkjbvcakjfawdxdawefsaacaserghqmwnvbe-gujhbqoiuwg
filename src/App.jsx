...
const PLANS = [
  { name: 'Старт', desc: 'Одностраничный лендинг для проверки ниши.' },
  { name: 'Бизнес', desc: 'Лендинг с формой заявок и интеграцией в Telegram.' },
  { name: 'Про', desc: 'Расширенный лендинг с прайсом, отзывами и аналитикой.' },
]
            ...
            <div className="price__grid">
              {PLANS.map((p) => (
                <div className="price__card" key={p.name}>
                  <h3>{p.name}</h3>
                  <p>{p.desc}</p>
                  <span className="price__value">Цена уточняется</span>
